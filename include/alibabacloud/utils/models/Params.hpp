...
namespace Models
{
  ...
  public:
    ...
    inline string bodyType() const { DARABONBA_PTR_GET_DEFAULT(bodyType_, "") };
    ...
    inline string reqBodyType() const { DARABONBA_PTR_GET_DEFAULT(reqBodyType_, "") };
  ...
  protected:
    ...
    std::shared_ptr<string> bodyType_ = nullptr;
    std::shared_ptr<string> reqBodyType_ = nullptr;
